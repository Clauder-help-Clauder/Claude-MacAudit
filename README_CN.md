...
> 🛠 **实时构建指标** — 版本：**v0.3.2** · 发版日期：**2026-05-13** · 累计 AI token 消耗（v0.1.0 至今）：**约 28 亿+ 输入/输出 + 约 180 亿+ 缓存**（跨 Claude / GPT / Gemini / Codex / 本地模型，数百个会话）
...
| 版本 | 日期 | 要点 | Release |
|------|------|------|---------|
| **v0.3.2** | 2026-05-13 | GUI 窗口尺寸优化 — 默认 1440×860，Logo padding 避让 macOS 红绿黄按钮，侧边栏菜单紧凑度优化 | [→ v0.3.2](https://github.com/Clauder-help-Clauder/Claude-MacAudit/releases/tag/v0.3.2) |
